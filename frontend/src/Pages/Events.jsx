    ...
    <div className="bg-EventBG">
      <div className="w-full flex items-center justify-center h-screen">
        <div className="flex flex-col gap-6 z-30 absolute">
          <h1 className="text-5xl md:text-[150px] text-white font-cuda">Events</h1>
          <h1 className="text-2xl text-white font-cuda text-center">Prizes upto 2 Lakhs</h1>
        </div>
        <video autoPlay loop muted className="absolute z-10 w-full h-full object-cover brightness-90">
