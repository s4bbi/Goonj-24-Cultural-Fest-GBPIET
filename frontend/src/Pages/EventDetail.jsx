...
const EventDetail = () => {
    ...
    return (
        <div className="w-full bg-cover">
            <div className="bg-bg_image bg-cover py-16 px-5 md:px-20 md:py-36 h-full hover:none">
                <div className="text-white">
                    <div className="w-full flex justify-between py-4 items-center">
                        ...
                        <div className="flex gap-5 text-sm">
                            <button className="bg-[#5F43B2] font-cM md:text-xl px-6 py-1 rounded-full shadow-md shadow-[#5F43B2] hover:bg-[#5c2ee3]">
                                REGISTER
                            </button>
                            <Link to="">
                                <button className="w-full bg-[#5F43B2] font-cM md:text-xl px-6 py-1 rounded-full shadow-md shadow-[#5F43B2] hover:bg-[#5c2ee3]">
                                    RULE BOOK
                                </button>
                            </Link>    
                        </div>
                    ...
                    <div>
                        ...
                        <div className="font-normal font-cR md:text-xl text-sm text-white md:my-10">
                            ...
                            <p><span className="font-cR md:my-10">VOTING CRITERIA: </span>60% judges votes + 20% jury votes + 20% audience votes will determine the final winner.</p>
                        </div>
                    </div>
                </div>
            </div>
