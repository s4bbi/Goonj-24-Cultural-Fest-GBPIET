                    ...
                    <div className="flex flex-col gap-16 md:flex-row justify-between items-center">
                        ...
                        <div className="w-full md:w-8/12">
                            <div className="flex flex-col gap-14 font-cM text-center md:text-left">
                                <h2 className="text-4xl text-white">About<span className="text-[#5F43B2] mx-3 font-cSB">GBPIET</span></h2>
                    ...
                    <div className="flex flex-col gap-16 md:flex-row justify-between items-center">
                        ...
                        <div className="w-full md:w-8/12">
                            <div className="flex flex-col gap-14 font-cM text-center md:text-left">
                                ...
                                <p className="text-white text-center">Read More About our Privacy Policy <Link to={"https://docs.google.com/document/d/18pMLKk-fZLpVLCXkrFziC8W-dTyusZPkl9AZ5abZVrY/edit?usp=sharing"}><span className="text-[#5f43b2]">HERE</span></Link></p>
                            </div>
                        </div>
                    </div>
                </section>
                        ...
                        <div className="w-full md:w-8/12">
                            <div className="flex flex-col gap-14 font-cM text-center md:text-left">
                                ...
                                <div className="flex flex-col gap-2 text-center ">
                                    ...
                                    <p className="text-white text-sm ">chandraprakashpandey2003@gmail.com</p>
                                </div>
                                <div className="flex flex-col gap-2 text-center">
