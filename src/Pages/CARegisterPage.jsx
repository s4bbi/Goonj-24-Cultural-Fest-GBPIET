        ...
        <div className="">
          <div className='p-2'>
            ...
            <div className='flex justify-between  px-12 py-10'>
              <div
                className='w-[500px] md:w-[770px] h-[800px] md:h-[500px] rounded-3xl bg-cover bg-center bg-no-repeat text-white  b-1 -my-6 md:mx-10'
                style={{
                ...
                <div className='p-10 absolute'>
                  ...
                  <div className='flex flex-col justify-between md:flex-row md:gap-12 md:py-2'>
                    <div className='py-3'>
                      ...
                      <select
                        name='College City'
                        className='bg-[#5f43b2] px-3 rounded-lg  w-80 py-4 text-start'>
