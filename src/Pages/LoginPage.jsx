...
const LoginPage = () => {
  return (
    <div className="bg-EventBG h-fit flex justify-center">
      ...
      <div className="sm:w-6/12 my-24 sm:mr-20 mx-2 rounded-3xl bg-cover bg-center bg-no-repeat text-white  " style={{ backgroundImage: "url('/src/assets/Images/LoginBG.png')" }}>
